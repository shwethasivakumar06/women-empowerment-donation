      ...
      <section className="impact">
        ...
        <div className="cards">
          <div className="card">
            ...
            <p>Trained in financial literacy, entrepreneurship, and education.</p>
          </div>
          <div className="card">
            <h3>🧕 500+ Programs</h3>
            <p>Health, safety, education, and empowerment sessions across India.</p>
          </div>
          <div className="card">
            <h3>🤝 900+ Volunteers</h3>
            <p>Community-driven initiatives powered by passionate supporters.</p>
          </div>
        </div>
      </section>
